...
const styles = StyleSheet.create({
  ...
  brandGlow: { position: 'absolute', width: 112, height: 112, borderRadius: 999, right: -32, top: -32, backgroundColor: 'rgba(174,238,203,0.32)' },
  ...
  licenseBadge: { alignSelf: 'flex-start', maxWidth: '100%', marginTop: 4, borderRadius: 999, paddingHorizontal: 8, paddingVertical: 3, flexDirection: 'row', alignItems: 'center', gap: 4, backgroundColor: 'rgba(174,238,203,0.6)' },
  ...
  gainBadge: { borderRadius: 2, paddingHorizontal: 6, paddingVertical: 2, backgroundColor: 'rgba(174,238,203,0.7)' },
  ...
  warehouseCaption: { position: 'absolute', left: 0, right: 0, bottom: 0, minHeight: 45, paddingHorizontal: 12, flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: 'rgba(1,45,29,0.78)' },
  ...
  dealText: { color: '#C1ECD4', fontFamily: FONT.publicSansSemiBold },
  ...
  summaryFooter: { minHeight: 40, marginHorizontal: -16, marginTop: 2, paddingHorizontal: 16, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', backgroundColor: 'rgba(255,255,255,0.1)' },
  ...
  scrim: { ...StyleSheet.absoluteFill, backgroundColor: 'rgba(44,50,46,0.42)' },
  ...
  currentBadge: { borderRadius: 4, paddingHorizontal: 8, paddingVertical: 4, backgroundColor: 'rgba(174,238,203,0.7)' },
